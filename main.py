...
class Avtorizaciya(Frame):
    ...
    def create_widgets(self):
        ...
        def vxod():
            ...
            if self.imya.get()=='admin' and self.parol.get() =='admin':
                self.master.withdraw()
                self.new_InfoWindow = Toplevel(self.master)
...
class user(Frame):
    ...
    def create_widgit(self):
        ...
        def str1():
            self.master.withdraw()
            self.new_InfoWindow = Toplevel(self.master)
            self.info_window = sdelki(self.new_InfoWindow)
        ...
        def str2():
            self.master.withdraw()
            self.new_InfoWindow = Toplevel(self.master)
            self.info_window = pokazuser(self.new_InfoWindow)
...
class pokazuser(Frame):
    ...
    def create_widgit(self):
        ...
        def search():
            if self.nomer.get()=='' and  self.cvet.get()=='' and  self.qod.get()=='' and self.model.get()=='' and  self.cena.get()=='' :
                query = self.marka.get()


            elif self.marka.get()=='' and  self.cvet.get()=='' and  self.qod.get()=='' and self.model.get()=='' and  self.cena.get()=='' :
                query = self.nomer.get()

            elif self.marka.get()=='' and  self.nomer.get()=='' and  self.qod.get()=='' and self.model.get()=='' and  self.cena.get()=='':
                query = self.cvet.get()

            elif self.marka.get()=='' and  self.nomer.get()=='' and  self.cvet.get()=='' and self.model.get()=='' and  self.cena.get()=='' :
                query = int(self.qod.get())

            elif self.marka.get()=='' and  self.nomer.get()=='' and  self.cvet.get()=='' and self.qod.get()=='' and  self.cena.get()=='' :
                query = self.model.get()

            elif self.marka.get()=='' and  self.nomer.get()=='' and  self.cvet.get()=='' and self.qod.get()=='' and  self.model.get()=='' :
                query = int(self.cena.get())
